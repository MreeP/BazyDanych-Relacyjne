<x-admin::app-layout :header="__('Dashboard')">
    <div class="py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            <!-- Total Users Card -->
            <div class="bg-white overflow-hidden shadow border border-gray-100 sm:rounded-lg p-6">
        ...
        <!-- Activity Chart -->
        <div class="bg-white overflow-hidden shadow border border-gray-100 sm:rounded-lg p-6 mb-8">
